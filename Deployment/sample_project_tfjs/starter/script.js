...
async function init(){
    ...
    model = await tf.loadLayersModel('http://127.0.0.1:8887/tfjs_model/model.json'); // Untuk VS Code Live Server
    // model = await tf.loadLayersModel('http://127.0.0.1:8080/tfjs_model/model.json');
    isModelLoaded = true;
 
    //Memanggil word_index
    const word_indexjson = await fetch('http://127.0.0.1:8887/word_index.json'); // Untuk VS Code Live Server
    // const word_indexjson = await fetch('http://127.0.0.1:8080/word_index.json');
